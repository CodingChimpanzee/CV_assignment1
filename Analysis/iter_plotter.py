...
plt.title("Tendency between MSE and iteration time (step size = 0.002)", fontsize = 20)
plt.axhline(500, color='black')
plt.axvline(0, color='black')
plt.xlabel('Iteration time', fontsize = 17)
...
plt.title("Tendency between PSNR and iteration time (step size = 0.002)", fontsize = 20)
...
plt.title("Tendency between MSE and iteration time using prior (step size = 0.002)", fontsize = 20)
plt.axhline(500, color='black')
plt.axvline(0, color='black')
plt.xlabel('Iteration time', fontsize = 17)
plt.ylabel('MSE value', fontsize = 17)
...
plt.title("Tendency between PSNR and iteration time using prior (step size = 0.002)", fontsize = 20)
plt.axhline(0, color='black')
plt.axvline(0, color='black')
plt.xlabel('Iteration time', fontsize = 17)
plt.ylabel('PSNR value', fontsize = 17)
