...
# Save the value
np.save("../Analysis/iter_val_1.npy", iter_times)
np.save("../Analysis/iter_mse_val_1.npy", mse_val)
np.save("../Analysis/iter_psnr_val_1.npy", psnr_val)
...
# Save the value
np.save("../Analysis/iter_val_2.npy", iter_times)
np.save("../Analysis/iter_mse_val_2.npy", mse_val)
np.save("../Analysis/iter_psnr_val_2.npy", psnr_val)